...
const publicPages = ["Register", "Ticket", "Landing", "EventDetails", "EventTicketing", "EventDetails"];
...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex">
      ...
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-slate-100 z-40 px-4 py-3 flex items-center gap-3">
