  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: hov
          ? `0 0 40px rgba(190,255,0,0.55), 0 0 80px rgba(190,255,0,0.2)`
          : `0 0 20px rgba(190,255,0,0.25)`,
...
export default function EventDetails() {
  ...
  const { data: event, isLoading } = useQuery({
    ...
    queryFn: () =>
      base44.entities.Event.filter({ id: eventId }).then((res) => res[0]),
    enabled: !!eventId,
  });
  ...
  const sponsorLogos = Array.isArray(event.sponsor_logo_urls)
    ? event.sponsor_logo_urls.filter(Boolean)
    : [];
  ...
  return (
    ...
    >
      ...
      >
        {event.cover_video_url ? (
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse at 30% 40%, rgba(190,255,0,0.07) 0%, transparent 60%), radial-gradient(ellipse at 70% 80%, rgba(0,50,120,0.12) 0%, transparent 60%), #070707",
              zIndex: 0,
            }}
          />
        )}
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, rgba(7,7,7,0.3) 0%, rgba(7,7,7,0.1) 40%, rgba(7,7,7,0.85) 80%, #070707 100%)",
            zIndex: 1,
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 50% 100%, rgba(190,255,0,0.04) 0%, transparent 70%)",
            zIndex: 1,
          }}
        />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              100% kostenlos · Registrierung dauert 60 Sekunden
            </p>
          </div>
        </motion.div>
      </section>
      ...
      >
        ...
        >
          {event.name} · powered by DLS Consulting, BIANCO Berlin, ReachCon
        </p>
      </footer>
    </div>
  );
